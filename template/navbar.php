...
include_once($root . "/dao/DaoMensagem.php");

$daoMensagem = new DaoMensagem();

$countMensagens = $daoMensagem->getCountMensagens($conn, $_SESSION["casaId"]);
$mensagens = $daoMensagem->getMensagens($conn, $_SESSION["casaId"]);
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-danger navbar-badge"><?= $countMensagens ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <?php while ($mensagem = mysqli_fetch_assoc($mensagens)) { ?>
