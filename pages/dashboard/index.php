      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-info" onclick="location.href='/smart_house/pages/moradores/moradores.php';" style="cursor: pointer;">
              <div class="inner">
                <h3><?= $qtdMoradores ?></h3>
          ...
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-success" onclick="location.href='/smart_house/pages/comodos/comodos.php';" style="cursor: pointer;">
              <div class="inner">
                <h3><?= $qtdComodos ?></h3>
          ...
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-danger" onclick="location.href='/smart_house/pages/aparelhos/aparelhos.php';" style="cursor: pointer;">
              <div class="inner">
                <h3><?= $qtdAparelhos ?></h3>
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  ...
                  <li>
                    ...
                    <div class="tools">
                      <a href="/smart_house/pages/rotinas/alterar_rotina.php?id=<?= $linha["rotinaId"] ?>"><i class="fas fa-edit"></i></a>
                    </div>
                  </li>
                  <?php } ?>
                </ul>
              ...
              <div class="card-footer clearfix">
                <a href="/smart_house/pages/rotinas/cadastrar_rotina.php" type="button" class="btn btn-info float-right"><i class="fas fa-plus"></i> Adicionar Rotina</a>
              </div>
            </div>
            <!-- /.card -->
          </section>
