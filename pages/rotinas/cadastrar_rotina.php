...
if (isset($_GET["cenaId"])) {
  $cenaId = $_GET["cenaId"];
} else {
  $cenaId = null;
}

if (isset($_POST["aparelhoId"]) && isset($_POST["dataHora"])) {
  if ($daoRotina->salvarRotina($conn, $_POST)) {
    if ($_POST["cenaId"] != null) {
      header("Location: /smart_house/pages/cenas/alterar_cena.php?id=" . $_POST["cenaId"] . "&success=1");
    } else {
      header("Location: rotinas.php?success=1");
    }
  } else {
    if ($_POST["cenaId"] != null) {
      header("Location: /smart_house/pages/cenas/alterar_cena.php?id=" . $_POST["cenaId"] . "&success=0");
    } else {
      header("Location: rotinas.php?success=");
    }
  }
}
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Cadastrar Rotina</h3>
                  <a type="button" href="rotinas.php" class="btn btn-secondary btn-sm"><i class="fas fa-undo"></i></a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" id="quickForm" action="cadastrar_rotina.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group date" id="dataHora" data-target-input="nearest">
                          <input type="text" name="dataHora" class="form-control datetimepicker-input" data-target="#dataHora" />
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <input type="checkbox" name="acao" checked data-bootstrap-switch data-off-color="danger" data-on-color="success">
                      </div>
                    </div>
                    <input type="hidden" name="cenaId" value="<?= $cenaId ?>">
                    <div class="row">
                      <div class="col-md-6">
  ...
  <!-- Bootstrap Switch -->
  <script src="/smart_house/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
  <!-- ChartJS -->
