<?php
  ...
  if (isset($_GET["aprovar"])) {
      echo '<input type="hidden" id="usuarioAprovado" value="true">';
  } else if (isset($_GET["reprovar"])) {
      echo '<input type="hidden" id="usuarioAprovado" value="false">';
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pedidos de Ativação</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Gerenciamento</a></li>
              <li class="breadcrumb-item active">Pedidos de Ativação</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <?php while ($linha = mysqli_fetch_assoc($pedidos)) { ?>
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <div class="btn-group">
                          <a type="button" href="pedido_cadastro.php?aprovar=<?= $linha["pessoaId"] ?>" class="btn btn-warning"><i class="fas fa-thumbs-up"></i></a>
                          <a type="button" href="pedido_cadastro.php?reprovar=<?= $linha["pessoaId"] ?>" class="btn btn-danger"><i class="fas fa-thumbs-down"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php } ?>
...
<script>
  ...
  $(function() {
    ...
    const usuarioAprovado = $('#usuarioAprovado').val();

    if (usuarioAprovado == "true") {
      printToast("Pedido Aprovado!", "success");
    } else if (usuarioAprovado == "false") {
      printToast("Pedido Reprovado!", "error");
    }
  });
</script>
<!-- JQVMap -->
