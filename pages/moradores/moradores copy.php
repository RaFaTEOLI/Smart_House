          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <?php while ($morador = mysqli_fetch_assoc($moradores)) { ?>
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                      <div class="inner">
                        <a id="remover" href="excluir_morador.php?id=<?= $linha["moradorId"] ?>" data-toggle="modal" data-target="#modalNumeros" style="position:absolute; right:5px;top:5px;" class="text-danger"><i class="fas fa-trash"></i></a>
                        <h3><?= $morador["nome"] ?></h3>
              ...
              <table id="ativacoes" class="table table-bordered table-striped table-responsive-sm">
                ...
                <tbody>
                <?php while ($linha = mysqli_fetch_assoc($moradores)) { ?>
                  <tr>
                    ...
                    <td align="center">
                      <div class="btn-group">
                          <a type="button" href="excluir_morador.php?id=<?= $linha["moradorId"] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php } ?>
