<?php
  ...
  if (isset($_POST["nome"]) && isset($_POST["descricao"])) {
    if ($daoAparelho->alterarAparelho($conn, $_POST)) {
          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex justify-content-between">
                <h3 class="card-title">Alterar Aparelho</h3>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="nome" class="form-control" id="nome" placeholder="Digite o nome" value="<?= $aparelho["nome"] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="descricao">Descrição *</label>
                        <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Digite a descrição" value="<?= $aparelho["descricao"] ?>">
                    </div>
                  </div>
                  <div class="row">
