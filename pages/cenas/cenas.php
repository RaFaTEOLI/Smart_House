...
$cenas = $daoCena->getCenas($conn);

if (isset($_GET["success"])) {
  if ($_GET["success"] == 1) {
    echo '<input type="hidden" id="cenaInserida" value="true">';
  } else {
    echo '<input type="hidden" id="cenaInserida" value="false">';
  }
}
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Cenas</h3>
                  <a type="button" href="cadastrar_cena.php" class="btn btn-secondary btn-sm"><i class="fas fa-plus"></i></a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    <?php while ($linha = mysqli_fetch_assoc($cenas)) { ?>
                      <tr>
                        ...
                        <td align="center">
                          <div class="btn-group">
                            <a type="button" href="alterar_cena.php?id=<?= $linha["cenaId"] ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                            <a type="button" href="excluir_cena.php?id=<?= $linha["cenaId"] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                          </div>
                        </td>
                      </tr>
                    <?php } ?>
  ...
  <script>
    ...
    $(function() {
      ...
      const cenaInserida = $('#cenaInserida').val();

      if (cenaInserida == "true") {
        printToast("Ação realizada!", "success");
      } else if (cenaInserida == "false") {
