...
if (isset($_POST["nome"]) && isset($_POST["dataHora"]) && isset($_POST["descricao"])) {
  $id = $daoCena->salvarCena($conn, $_POST);

  if ($id > 0) {
    header("Location: alterar_cena.php?id={$id}");
  } else {
            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Cadastrar Cena</h3>
                  <a type="button" href="cenas.php" class="btn btn-secondary btn-sm"><i class="fas fa-undo"></i></a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" id="quickForm" action="cadastrar_cena.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
