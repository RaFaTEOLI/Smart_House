                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex justify-content-between">
                      ...
                      <a type="button" href="/smart_house/pages/rotinas/cadastrar_rotina.php?cenaId=<?= $where ?>" class="btn btn-secondary btn-sm"><i class="fas fa-plus"></i></a>
                    </div>
                  </div>
                    ...
                    <tbody>
                      <?php while ($rotina = mysqli_fetch_assoc($rotinas)) { ?>
                        <tr>
                          ...
                          <td align="center">
                            <div class="btn-group">
                              <a type="button" href="/smart_house/pages/rotinas/alterar_rotina.php?id=<?= $rotina["rotinaId"] ?>&cena=1" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                              <a type="button" href="/smart_house/pages/rotinas/excluir_rotina.php?id=<?= $rotina["rotinaId"] ?>&cena=1" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php } ?>
