<?php
  ...
  include($root . "/dao/DaoLog.php");

  $daoLog = new DaoLog();

  $logs = $daoLog->getLogs($conn, $_SESSION["casaId"]);

  function stringToBadge($acao) {
    switch($acao) {
      case "Inserir": 
        return "<span class='badge badge-primary'>Inserir</span>";
      break;
      case "Alterar": 
        return "<span class='badge badge-secondary'>Alterar</span>";
      break;
      case "Excluir": 
        return "<span class='badge badge-danger'>Excluir</span>";
      break;
    }
  }
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Logs do Sistema</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="ativacoes" class="table table-bordered table-striped table-responsive-sm">
                ...
                <tbody>
                <?php while ($linha = mysqli_fetch_assoc($logs)) { ?>
                  <tr>
